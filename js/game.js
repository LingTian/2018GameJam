...
window.onload = function() {
    ...
    const contractPromise = tronWeb.contract().at("41fd46e6897df5a58d0cb375e79dd3ba7cc404e7c2").then(function(result) {
    ...
    //     bytecode: byteCode,
    //     feeLimit: 30000
    // }, 'TPb5eaSSd4rsQzUkDEZenYKxn3H1PFVJWc', (err, transaction) => {
    //     if(err)
    //         return console.error(err);
    //
    //     console.group('Unsigned create smart contract transaction');
    //     console.log('- Issuer Address: TPb5eaSSd4rsQzUkDEZenYKxn3H1PFVJWc');
...
async function getCharacterNo(callback){
    ...
    const contract = await tronWeb.contract().at("41f2a2aaecdb44ea9eedbd12275ecacccd751ef5cf");
    let res = await contract.getCharacterNo().send();
    callback && callback(res.toString(10));
}
...
$(window).ready(function () {
    ...
    $(".button").click(function () {
        ...
        // animateElems();
        getCharacterNo((resStr) => console.warn("Res of getting no chara: " + resStr));
    });
